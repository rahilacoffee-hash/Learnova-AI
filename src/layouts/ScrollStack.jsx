...
const ScrollStack = ({
  ...
  const setupLenis = useCallback(() => {
    ...
    const lenis = useWindowScroll
      ...
      : new Lenis({ ...lenisConfig, wrapper: scrollerRef.current, content: scrollerRef.current?.querySelector('.scroll-stack-inner') });
  ...
  return (
    <div
      ...
      ref={scrollerRef}
      style={{ overscrollBehavior: 'contain', WebkitOverflowScrolling: 'touch', transform: 'translateZ(0)' }}
    >
