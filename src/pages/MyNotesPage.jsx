...
const MyNotesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f7fb] relative overflow-hidden">
      {/* Glow Effects */}
      <div className="absolute top-20 left-40 w-[500px] h-[500px] bg-violet-500/15 blur-[180px] rounded-full" />

      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-cyan-500/15 blur-[180px] rounded-full" />
